                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">MongoDB</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">Express</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">React</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">Node.js</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">Github</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">Framer Motion</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">Python</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">JavaScript</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">Tailwind CSS</p>
                                </div>
                        </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    ...
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm">PHP</p>
                                </div>
                        </motion.div>
                        </div>
                    </div>
