    ...
    const stacks = [
        {
            ...
            icon: <SiMongodb className="text-green-500" size={35}/>
        },
        {
            name: "Express",
            bgColor: "from-gray-800 to-gray-600",
            icon: <FaNodeJs className="text-gray-300" size={35}/>
        },
        {
            name: "React",
            bgColor: "from-blue-900 to-blue-700",
            icon: <FaReact className="text-blue-400" size={35}/>
        },
        {
            name: "Node.js",
            bgColor: "from-green-900 to-green-700",
            icon: <FaNodeJs className="text-green-500" size={35}/>
        },
        {
            name: "Github",
            bgColor: "from-gray-900 to-gray-700",
            icon: <FaGithub className="text-gray-300" size={35}/>
        },
        {
            name: "Framer Motion",
            bgColor: "from-gray-800 to-gray-600",
        ...
        },
        {
            ...
            icon: <FaPython className="text-blue-300" size={35}/>
        },
        {
            name: "JavaScript",
            bgColor: "from-yellow-900 to-yellow-700",
            icon: <SiJavascript className="text-yellow-400" size={35}/>
        },
        {
            name: "Tailwind CSS",
            bgColor: "from-cyan-900 to-cyan-700",
            icon: <SiTailwindcss className="text-cyan-400" size={35}/>
        },
        {
            name: "PHP",
            bgColor: "from-gray-900 to-gray-700",
            icon: <SiPhp className="text-gray-300" size={35}/>
        }
    ]
    return ( 
        <div id="stack">
                            ...
                            stacks.map((stack, index) => (
                                <div key={index} data-aos="fade-right">
                                    <motion.div
                                        ...
                                        whileTap={{ scale: 0.8 }}    
                                        className={`bg-gradient-to-br ${stack.bgColor} rounded-xl flex justify-center items-center p-6`}
                                        style={{ 
                                        ...
                                        <div className="text-4xl">
                                            ...
                                            <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">{stack.name}</p>
                                        </div>
                                    </motion.div>
                                </div>
                            ))
