...
import { SiTypescript, SiMongodb, SiTailwindcss, SiPhp, SiJavascript } from 'react-icons/si';
            ...
            <div className="min-h-screen bg-gradient-to-b from-black via-green-900 to-gray-950">
                <div className="py-20 px-10">
                    <div className="flex flex-col items-center gap-4 mb-10" data-aos="fade-down-right">
                        <h1 className="Geist text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-green-700 md:text-5xl text-4xl font-bold">Tech Stack</h1>
                        <div className="w-40 h-px mx-auto bg-gradient-to-r from-green-900 via-green-500 to-green-900"></div>
                        <p className="Geist md:text-xl text-sm font-semibold text-center text-gray-300">The digital tools I wield to craft exceptional experiences</p>
                    </div>
                    <div className="grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 gap-9">
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                whileTap={{ scale: 0.8 }}    
                                className="bg-gradient-to-br from-green-900 to-green-700 rounded-xl flex justify-center items-center p-6"
                                style={{ 
                                ...
                                <div className="text-4xl">
                                    <div className="flex justify-center items-center mb-4">
                                        <SiMongodb className="text-green-500" size={35}/>
                                    </div>
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">MongoDB</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                whileHover={{ scale: 1.2 }}
                                whileTap={{ scale: 0.8 }}    
                                className="bg-gradient-to-br from-gray-800 to-gray-600 rounded-xl flex justify-center items-center p-6"
                                style={{ 
                                boxShadow: "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px"
                                }}>
                                <div className="text-4xl">
                                    <div className="flex justify-center items-center mb-4">
                                        <FaNodeJs className="text-gray-300" size={35}/>
                                    </div>
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">Express</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                whileHover={{ scale: 1.2 }}
                                whileTap={{ scale: 0.8 }}    
                                className="bg-gradient-to-br from-blue-900 to-blue-700 rounded-xl flex justify-center items-center p-6"
                                style={{ 
                                boxShadow: "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px"
                                }}>
                                <div className="text-4xl">
                                    <div className="flex justify-center items-center mb-4">
                                        <FaReact className="text-blue-400" size={35}/>
                                    </div>
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">React</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    <div className="flex justify-center items-center mb-4">
                                        <FaNodeJs className="text-green-500" size={35}/>
                                    </div>
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">Node.js</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                whileHover={{ scale: 1.2 }}
                                whileTap={{ scale: 0.8 }}    
                                className="bg-gradient-to-br from-gray-900 to-gray-700 rounded-xl flex justify-center items-center p-6"
                                style={{ 
                                boxShadow: "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px"
                                }}>
                                <div className="text-4xl">
                                    <div className="flex justify-center items-center mb-4">
                                        <FaGithub className="text-gray-300" size={35}/>
                                    </div>
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">Github</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                whileHover={{ scale: 1.2 }}
                                whileTap={{ scale: 0.8 }}    
                                className="bg-gradient-to-br from-blue-800 to-blue-600 rounded-xl flex justify-center items-center p-6"
                                style={{ 
                                boxShadow: "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px"
                                }}>
                                <div className="text-4xl">
                                    <div className="flex justify-center items-center mb-4">
                                        <FaPython className="text-blue-300" size={35}/>
                                    </div>
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">Python</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                whileHover={{ scale: 1.2 }}
                                whileTap={{ scale: 0.8 }}    
                                className="bg-gradient-to-br from-yellow-900 to-yellow-700 rounded-xl flex justify-center items-center p-6"
                                style={{ 
                                boxShadow: "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px"
                                }}>
                                <div className="text-4xl">
                                    <div className="flex justify-center items-center mb-4">
                                        <SiJavascript className="text-yellow-400" size={35}/>
                                    </div>
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">JavaScript</p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                whileHover={{ scale: 1.2 }}
                                whileTap={{ scale: 0.8 }}    
                                className="bg-gradient-to-br from-cyan-900 to-cyan-700 rounded-xl flex justify-center items-center p-6"
                                style={{ 
                                boxShadow: "rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px"
                                }}>
                                <div className="text-4xl">
                                    <div className="flex justify-center items-center mb-4">
                                        <SiTailwindcss className="text-cyan-400" size={35}/>
                                    </div>
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">Tailwind CSS</p>
                                </div>
                        </motion.div>
                        </div>
                        ...
                        <div data-aos="fade-right">
                            <motion.div
                                ...
                                <div className="text-4xl">
                                    <div className="flex justify-center items-center mb-4">
                                        <SiPhp className="text-gray-300" size={35}/>
                                    </div>
                                    <p className="Geist font-bold text-gray-200 md:text-lg text-sm whitespace-nowrap">PHP</p>
                                </div>
                        </motion.div>
                        </div>
                    </div>
